  ...
  <div class="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 p-8">
    <div class="max-w-4xl mx-auto">
      <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-white mb-2">Create Product</h1>
        <p class="text-primary-200">Add a new financial product to the system</p>
      </div>

      <div class="bg-white/10 backdrop-blur-lg rounded-lg p-8 border border-primary-600">
...
const { loading, error, createProduct } = productStore
